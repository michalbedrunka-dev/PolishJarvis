...
class MainWindow(QMainWindow):
    ...
    def _build_header(self) -> QWidget:
        ...
        lay.addWidget(_badge("MARK I", C.PRI_DIM))
        lay.addStretch()
    ...
    def _build_right_panel(self) -> QWidget:
        ...
        self._interrupt_btn.setStyleSheet(f"""
            ...
            QPushButton:hover {{
                background: rgba(255,255,255,0.08); border: 1px solid {C.PRI};
            }}
            QPushButton:pressed {{
        ...
        self._mute_btn.setStyleSheet(f"""
            ...
            QPushButton:hover {{
                background: rgba(255,255,255,0.1); border: 1px solid {C.PRI};
            }}
        """)
        ...
        remote_btn.setStyleSheet(f"""
            QPushButton {{
                background: rgba(99,102,241,0.08); color: {C.PRI};
                border: 1px solid rgba(99,102,241,0.16); border-radius: 6px;
            }}
            QPushButton:hover {{
                background: rgba(99,102,241,0.14); border: 1px solid {C.PRI};
            }}
        """)
        ...
        fs_btn.setStyleSheet(f"""
            ...
            QPushButton:hover {{
                color: {C.PRI}; border: 1px solid rgba(255,255,255,0.1);
            }}
        """)
        ...
        sc_btn.setStyleSheet(f"""
            ...
            QPushButton:hover {{
                color: {C.ACC2}; border: 1px solid rgba(255,255,255,0.1);
            }}
        """)
    ...
    def _build_input_row(self) -> QHBoxLayout:
        ...
        send.setStyleSheet(f"""
            QPushButton {{
                background: rgba(99,102,241,0.14); color: {C.PRI};
                border: 1px solid rgba(99,102,241,0.2); border-radius: 8px;
            }}
            QPushButton:hover {{ background: rgba(99,102,241,0.22); border: 1px solid {C.PRI}; }}
        """)
    ...
    def _build_footer(self) -> QWidget:
        ...
        lay.addStretch()
        lay.addWidget(_fl("W12E  ·  MARK I  ·  CLASSIFIED"))
        lay.addStretch()

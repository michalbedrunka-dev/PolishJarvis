...
try:
    ...
    sd = None
    print("[Main] sounddevice not available; continuing without audio input/output support.")
...
try:
    ...
    genai = None
    types = None
    print("[Main] google.genai not available; AI features will be limited until dependencies are installed.")
...
class JarvisLive:
    ...
    async def _send_startup_briefing(self) -> None:
        """Send a simple startup greeting without any news phase."""
        ...
        greeting = (
            f"Greet the user, mention it is {time_str}, and say a short welcome. "

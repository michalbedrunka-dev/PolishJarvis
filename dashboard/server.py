...
class DashboardServer:
    ...
    def _build_app(self) -> "FastAPI":
        ...
        async def login_page():
            # Load HTML dynamically to support live edits
            login_html = _read("login.html")
            return HTMLResponse(login_html, headers=_NO_CACHE_HEADERS)
        ...
        async def index():
            ...
            # Load HTML dynamically (not from cache) to support live edits
            app_html = _read("app.html")
            html = (app_html
